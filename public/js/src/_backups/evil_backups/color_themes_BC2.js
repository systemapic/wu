...
var basecolor;
var arrBlend = [];	// For color matching
...
var eCol = {
	...
	update : {
		...
		matchSwatch : function (number, HSV) {
		...
		// Updates all the swatches + cArray
		swatch : function (_hex) {
			
			// Updating the color swatches that contains the BASE color
			eCol.getObjectByID("swatch_1").style.backgroundColor = _hex;
			...
			// Match Color 1
			eCol.convert.hex2RGB(arrBlend[1], RGB);
			eCol.convert.RGB2HSV (RGB, HSV);
			
			cArray[4] = [];
			this.matchSwatch(4, HSV);
		
		
			// Match Color 2
			eCol.convert.hex2RGB(arrBlend[2], RGB);
			eCol.convert.RGB2HSV (RGB, HSV);
			
			cArray[5] = [];
			this.matchSwatch(5, HSV);
		
		
			// Match Color 3
			eCol.convert.hex2RGB(arrBlend[3], RGB);
			eCol.convert.RGB2HSV (RGB, HSV);
			
			cArray[6] = [];
			this.matchSwatch(6, HSV);
		
			
			// Match Color 4	
			eCol.convert.hex2RGB(arrBlend[4], RGB);
			eCol.convert.RGB2HSV (RGB, HSV);	
			
			cArray[7] = [];
			this.matchSwatch(7, HSV);
			
		
			// Match Color 5
			eCol.convert.hex2RGB(arrBlend[5], RGB);
			eCol.convert.RGB2HSV (RGB, HSV);
			
			cArray[8] = [];
			this.matchSwatch(8, HSV);
		...
		RGB : function () {
			...
			var RGB = new eCol.RGBobject(eCol.getObjectByID("rChannel").value, eCol.getObjectByID("gChannel").value, eCol.getObjectByID("bChannel").value);
			var HSV = new eCol.HSVobject(eCol.getObjectByID("hChannel").value, eCol.getObjectByID("sChannel").value, eCol.getObjectByID("vChannel").value);
				RGB.validate();
			
			eCol.RGB2HSV (RGB, HSV);
			
			_hexColor.value = eCol.convert.RGB2hex(RGB);
			_rChannel.value = Math.round(RGB.r);
			_gChannel.value = Math.round(RGB.g);
			_bChannel.value = Math.round(RGB.b);
			_hChannel.value = Math.round(HSV.h);
			_sChannel.value = Math.round(HSV.s);
			_vChannel.value = Math.round(HSV.v);
		...
		HEX : function () {
			...
			var colorString = eCol.getObjectByID("hexColor").value;
			var RGB = new eCol.RGBobject(0,0,0);
			var HSV = new eCol.HSVobject(0,0,0);
			eCol.convert.hex2RGB(colorString, RGB);
			eCol.convert.RGB2HSV (RGB, HSV);
		...
		// When colors changes, update array
		colChange : function (what) {
			...
			if ( what == 'HEX' ) {
				...
				_hex = eCol.getObjectByID("hexColor").value;
			...
			if ( changingColors == 'c0' ) {		
				...
				eCol.update.matchSwatch('c0', HSV);		
			...
			if ( changingColors == 'c1' ) {
				...
				eCol.convert.RGB2HSV (RGB, HSV);		
				eCol.update.matchSwatch('c1', HSV);
			...
			if ( changingColors == 'c2' ) {
				eCol.convert.RGB2HSV (RGB, HSV);
				eCol.update.matchSwatch('c2', HSV);
			...
			if ( changingColors == 'c3' ) {
				eCol.convert.RGB2HSV (RGB, HSV);
				eCol.update.matchSwatch('c3', HSV);
			...
			if ( changingColors == 'c4' ) {
				eCol.convert.RGB2HSV (RGB, HSV);
				eCol.update.matchSwatch('c4', HSV);
	...
	cMatch : {
		...
		outp: function (x, RGB) {
			...
			arrBlend[x]="#"+eCol.convert.hexify(RGB.r)+eCol.convert.hexify(RGB.g)+eCol.convert.hexify(RGB.b);
			this.__updateSwatch(parseInt(x)+1);		
			
		},
		
		__updateSwatch : function (sNo) {
	...
	// Makes light base colors (dark theme)
	makeLightColors : function (arrno,h) {
		...
		cArray[arrno][0].HEX = this.convert.HSV2HEX(h, 15, 80);	 
		cArray[arrno][0].RGB = {};
		this.convert.HSV2RGB(cArray[arrno][0].HSV, cArray[arrno][0].RGB);
		...
		cArray[arrno][1].HEX = this.convert.HSV2HEX(h, 1, 99);	 
		cArray[arrno][1].RGB = {};
		this.convert.HSV2RGB(cArray[arrno][1].HSV, cArray[arrno][1].RGB);
		...
		cArray[arrno][2].HEX = this.convert.HSV2HEX(h, 30, 25);	 
		cArray[arrno][2].RGB = {};
		this.convert.HSV2RGB(cArray[arrno][2].HSV, cArray[arrno][2].RGB);
	...
	// Makes dark base colors (light theme)
	makeDarkColors : function (arrno,h) {
		...
		cArray[arrno][0].HEX = this.convert.HSV2HEX(h, 50, 12);	 
		cArray[arrno][0].RGB = {};
		this.convert.HSV2RGB(cArray[arrno][0].HSV, cArray[arrno][0].RGB);
		...
		cArray[arrno][1].HEX = this.convert.HSV2HEX(h, 30, 25);	 
		cArray[arrno][1].RGB = {};
		this.convert.HSV2RGB(cArray[arrno][1].HSV, cArray[arrno][1].RGB);
		...
		cArray[arrno][2].HEX = this.convert.HSV2HEX(h, 15, 70);	 
		cArray[arrno][2].RGB = {};
		this.convert.HSV2RGB(cArray[arrno][2].HSV, cArray[arrno][2].RGB);
...
var	initClassArray = {
		...
		initStyleArray : function () {
			...
			var HSV = {}
				...
				HSV.s = 75;
				HSV.v = 75;
			eCol.update.matchSwatch(10, HSV);
			...
			var HSV = {}
				...
				HSV.s = 100;
				HSV.v = 100;
			eCol.update.matchSwatch(11, HSV);
...
//		eCol.sliders.updateAllSliders(cArray['c0'][0].RGB, cArray['c0'][0].HSV);		
	...
	if ( changingColors == 'c1' ) {
		...
		eCol.update.HEX();
		eCol.update.colChange('HEX');		
//		eCol.sliders.updateAllSliders(cArray['c1'][0].RGB, cArray['c1'][0].HSV);				
	}
	...
	if ( changingColors == 'c2' ) {
		...
		eCol.update.HEX();
		eCol.update.colChange('HEX');
//		eCol.sliders.updateAllSliders(cArray['c2'][0].RGB, cArray['c2'][0].HSV);		
	}
	...
	if ( changingColors == 'c3' ) {
		...
		eCol.update.HEX();
		eCol.update.colChange('HEX');
//		eCol.sliders.updateAllSliders(cArray['c3'][0].RGB, cArray['c3'][0].HSV);		
	}	
	...
	if ( changingColors == 'c4' ) {
		...
		eCol.update.HEX();
		eCol.update.colChange('HEX');
//		eCol.sliders.updateAllSliders(cArray['c4'][0].RGB, cArray['c4'][0].HSV);		
...
//	var nrgb = new eCol.cFind().getMostProminentColor(document.getElementById('canvimg'));
//	var nhex = RGB2hex(nrgb);
//	_hexColor.value = nhex;
//	hexChange();

	hexChange_start();
	initClassArray.initStyleArray();
	...
	eCol.makeDarkColors(23,215);	
	eCol.makeDarkColors(24,196);
	eCol.makeDarkColors(25,319);
	eCol.makeDarkColors(26,354);
	eCol.makeDarkColors(27,22);
	...
	cArray[28][0].HEX = eCol.convert.HSV2HEX(100, 0, 10);	 
	cArray[28][0].RGB = {};
	eCol.convert.HSV2RGB(cArray[28][0].HSV, cArray[28][0].RGB);
	...
	cArray[28][1].HEX = eCol.convert.HSV2HEX(100, 0, 20);	 
	cArray[28][1].RGB = {};
	eCol.convert.HSV2RGB(cArray[28][1].HSV, cArray[28][1].RGB);
	...
	cArray[28][2].HEX = eCol.convert.HSV2HEX(100, 0, 70);	 
	cArray[28][2].RGB = {};
	eCol.convert.HSV2RGB(cArray[28][2].HSV, cArray[28][2].RGB);
	...
	eCol.makeLightColors(29,215);
	eCol.makeLightColors(30,196);
	eCol.makeLightColors(31,319);
	eCol.makeLightColors(32,76);
	eCol.makeLightColors(33,354);
	...
	cArray[34][0].HEX = eCol.convert.HSV2HEX(22, 0, 70);	 
	cArray[34][0].RGB = {};
	eCol.convert.HSV2RGB(cArray[34][0].HSV, cArray[34][0].RGB);
	...
	cArray[34][1].HEX = eCol.convert.HSV2HEX(22, 0, 93);	 
	cArray[34][1].RGB = {};
	eCol.convert.HSV2RGB(cArray[34][1].HSV, cArray[34][1].RGB);
	...
	cArray[34][2].HEX = eCol.convert.HSV2HEX(22, 0, 25);	 
	cArray[34][2].RGB = {};
	eCol.convert.HSV2RGB(cArray[34][2].HSV, cArray[34][2].RGB);
...
function hexChange_start() {
	...
	eCol.convert.hex2RGB(colorString, RGB);
	eCol.convert.RGB2HSV (RGB, HSV);
	eCol.getObjectByID("rChannel").value = Math.round(RGB.r);
	eCol.getObjectByID("gChannel").value = Math.round(RGB.g);
	eCol.getObjectByID("bChannel").value = Math.round(RGB.b);
	eCol.getObjectByID("hChannel").value = Math.round(HSV.h);
	eCol.getObjectByID("sChannel").value = Math.round(HSV.s);
	eCol.getObjectByID("vChannel").value = Math.round(HSV.v);
...
function updateSwatch_start(_hex) {
	...
	eCol.convert.RGB2HSV (RGB, HSV);
	cArray[4] = [];
	eCol.update.matchSwatch(4, HSV);

	// Match Color 2
	eCol.convert.hex2RGB(arrBlend[2], RGB);
	eCol.convert.RGB2HSV (RGB, HSV);
	cArray[5] = [];
	eCol.update.matchSwatch(5, HSV);

	// Match Color 3
	eCol.convert.hex2RGB(arrBlend[3], RGB);
	eCol.convert.RGB2HSV (RGB, HSV);
	cArray[6] = [];
	eCol.update.matchSwatch(6, HSV);
	
	// Match Color 4	
	eCol.convert.hex2RGB(arrBlend[4], RGB);
	eCol.convert.RGB2HSV (RGB, HSV);	
	cArray[7] = [];
	eCol.update.matchSwatch(7, HSV);

	// Match Color 5
	eCol.convert.hex2RGB(arrBlend[5], RGB);
	eCol.convert.RGB2HSV (RGB, HSV);
	cArray[8] = [];
	eCol.update.matchSwatch(8, HSV);
