...
function rgbChange() {
	...
	if ( changingColors == 'c0' ) {
		...
		yourswatch.style.backgroundColor = selCol.c0[0].HEX;
	...
	if ( changingColors == 'c1' ) {
		...
		yourswatch.style.backgroundColor = selCol.c1[0].HEX;
	...
	if ( changingColors == 'c2' ) {
		...
		yourswatch.style.backgroundColor = selCol.c2[0].HEX;
	...
	if ( changingColors == 'c3' ) {
		...
		yourswatch.style.backgroundColor = selCol.c3[0].HEX;
	...
	if ( changingColors == 'c4' ) {
		...
		yourswatch.style.backgroundColor = selCol.c4[0].HEX;
...
function updateC0() {
	css[1].value  = selCol.c0[0].HEX; 	// BG: 	._color1bg, .ecolor1
	css[6].value  = selCol.c0[2].HEX;	// ~ :	._color4, .ecolor1, .disabled
	css[3].value  = selCol.c0[1].HEX; 	// BG:	._color2bg, .ecolor2
	css[22].value = selCol.c0[2].HEX; 	// ~ :	._color12, .nocolor
	css[7].value  = selCol.c0[2].HEX;	// BG: 	._color4bg, .ecolor4
	css[6].value  = selCol.c0[2].HEX;	// ~ :	._color4, .ecolor1, .disabled	
}
function updateC1() {
	css[13].value = selCol.c1[0].HEX;	// BG:	._color7bg, .color1
	css[15].value = selCol.c1[3].HEX; 	// BG:	._color8bg, .color2
	css[17].value = selCol.c1[4].HEX;	// BG:	._color9bg, .color3					
}
function updateC2() {
	css[19].value = selCol.c2[0].HEX;	// BG:	._color10bg, .selected
	css[21].value = selCol.c2[4].HEX;	// BG:	._color11bg
}
function updateC3() {
	css[4].value = selCol.c3[0].HEX;		// ~ :	._color3, .ecolor2, .activ a	
}
function updateC4() {
	css[22].value = selCol.c4[0].HEX;		// ~ :	._color3, .ecolor2, .activ a
}
...
function passcolor(arrn1) {
	...
	if ( changingColors == 'c0' ) {
		...
		_hexColor.value = selCol.c0[0].HEX;	
		updateAllSliders(selCol.c0[0].RGB, selCol.c0[0].HSV);		
			
	}
	
	// Menu color
	if ( changingColors == 'c1' ) {
		selCol.c1 = cArray[arrn1];
		
		// Updates the CSS array		
		updateC1();

		// Update the color blender/selector/values		
		_hexColor.value = selCol.c1[0].HEX;		
		hexChange();		
		updateAllSliders(selCol.c1[0].RGB, selCol.c1[0].HSV);				
	}

	// Active/selected color
	if ( changingColors == 'c2' ) {
		selCol.c2 = cArray[arrn1];

		// Updates the CSS array
		updateC2();
		
		// Update the color blender/selector/values
		_hexColor.value = selCol.c2[0].HEX;		
		hexChange();
		updateAllSliders(selCol.c2[0].RGB, selCol.c2[0].HSV);		
	}

	// Link color / dark background
	if ( changingColors == 'c3' ) {
		selCol.c3 = cArray[arrn1];

		// Updates the CSS array
		updateC3();

		// Update the color blender/selector/values
		_hexColor.value = selCol.c3[0].HEX;		
		hexChange();
		updateAllSliders(selCol.c3[0].RGB, selCol.c3[0].HSV);		
	}	

	// Link color / light background
	if ( changingColors == 'c4' ) {
		selCol.c4 = cArray[arrn1];		

		// Updates the CSS array
		updateC4();		
		
		// Update the color blender/selector/values
		_hexColor.value = selCol.c4[0].HEX;		
		hexChange();
		updateAllSliders(selCol.c4[0].RGB, selCol.c4[0].HSV);		
