...
module.exports = function () {
	describe('/api/project/hash/set', function () {
		...
		context('when saveState isn\'t define', function () {
		    ...
		    it('should respond with status code 200 and created hash', function (done) {
		        token(function (err, access_token) {
		            api.post('/api/project/hash/set')
		                .send({
		                    access_token: access_token,
		...
		context('when saveState is false', function () {
	        ...
	        it('should respond with status code 200 and should not change project state', function (done) {
	            token(function (err, access_token) {
	                api.post('/api/project/hash/set')
	                    .send({
	                        access_token: access_token,
		...
		context('when saveState is true but project with specific id does not exist', function () {
