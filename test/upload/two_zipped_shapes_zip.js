...
module.exports = function () {
    ...
    describe('Import two_zipped_shapes.zip', function () {
        ...
        describe(endpoints.import.post, function () {
	        ...
	        context('two_zipped_shapes.zip', function () {
	            this.timeout(21000);
	            ...
	            it('upload', function (done) {
	                token(function (err, access_token) {
	                    api.post(endpoints.import.post)
		                    ...
		                    .field('data', fs.createReadStream(path.resolve(__dirname, '../resources/two_zipped_shapes.zip')))
		                    ...
		                    .end(function (err, res) {
		                        ...
		                        expect(result.filename).to.be.equal('two_zipped_shapes.zip');
            ...
            token(function (err, access_token) {
                ...
                api.get(endpoints.import.download)
                    ...
                    .end(function (err, res) {
                        ...
                        expect(result.file.originalName).to.be.equal('two_zipped_shapes.zip');
                        expect(result.file.name).to.be.equal('two_zipped_shapes');
                        done();
                    });
            });
        });
